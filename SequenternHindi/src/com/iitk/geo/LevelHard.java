...
public class LevelHard extends Activity
{
	...
	{"पंचभुज","समलम्ब","आयत","Next","समलम्ब","आयत", "पंचभुज","गलत","गलत","पंचभुज"},
	{"समलम्ब","षट्भुज","पंचभुज","Next","षट्भुज","पंचभुज", "समलम्ब","गलत","समलम्ब","गलत"},
	{"आयत","त्रिभुज","विषमकोण","आयत","Next","विषमकोण", "त्रिभुज","त्रिभुज","गलत","गलत"},
	{"समचतुर्भुज","समलम्ब","आयत","समचतुर्भुज","Next","आयत", "समलम्ब","गलत","समलम्ब","गलत"},
	{"समलम्ब","आयत","विषमकोण","समलम्ब","Next","विषमकोण", "आयत","आयत","गलत","गलत"},
							
	{"वृत्त","आयत","षट्भुज","Next","आयत","षट्भुज", "वृत्त","गलत","वृत्त","गलत"},
	{"समचतुर्भुज","पंचभुज","विषमकोण","Next","पंचभुज","विषमकोण", "समचतुर्भुज","गलत","गलत","समचतुर्भुज"},
	{"पान","त्रिभुज","वर्ग","Next","त्रिभुज","वर्ग", "पान","गलत","गलत","पान"},
	{"तारा","पान","पंचभुज","Next","पान","पंचभुज", "तारा","गलत","तारा","गलत"},
	{"समलम्ब","पान","तारा","Next","पान","तारा", "समलम्ब","गलत","गलत","समलम्ब"},
	};
	@SuppressLint("NewApi")
	...
	protected class MyDragEventListener implements View.OnDragListener 
	 {
	   ...
	   case DragEvent.ACTION_DROP:
		   ...
		   if(target.getId()==3&&screenCounter>4)
		   {
			   ...
			   {
				  //if(sb.toString().length()>0)
					 //sb.append(String.valueOf(wrongCounter)+" ग़लती");
			      //Update score
				  if(sb.toString().length()==0)
				  sb.append("कोई गलती नहीं");
				  savescore(sb.toString());
