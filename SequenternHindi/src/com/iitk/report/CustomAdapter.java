        ...
        final Student st= student.get(position);
         ...
         if (v == null) 
         {
           ...
           if(st.getLevel1()==null||st.getLevel1().equals(""))
        	   level1status.setText("नहीं खेला");
           else
        	   level1status.setText("खेला");
           
           if(st.getLevel2()==null||st.getLevel2().equals(""))
        	   level2status.setText("नहीं खेला");
           else
        	   level2status.setText("खेला");
           
           if(st.getLevel3()==null||st.getLevel3().equals(""))
        	   level3status.setText("नहीं खेला");
           else
        	   level3status.setText("खेला");
           
           if(st.getLevel4()==null||st.getLevel4().equals(""))
        	   level4status.setText("नहीं खेला");
           else
        	   level4status.setText("खेला");
           
           if(st.getLevel5()==null||st.getLevel5().equals(""))
        	   level5status.setText("नहीं खेला");
           else
        	   level5status.setText("खेला");
           
           if(st.getLevel6()==null||st.getLevel6().equals(""))
        	   level6status.setText("नहीं खेला");
           else
        	   level6status.setText("खेला");
